	...
	implements DatabaseMetaData
{
	...
	public ResultSet getProcedures(String catalog, String schemaPattern, String procedureNamePattern)
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getProcedures(catalog, schemaPattern,
	...
	public ResultSet getProcedureColumns(String catalog, String schemaPattern,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getProcedureColumns(catalog, schemaPattern,
	...
	public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getTables(catalog, schemaPattern,
	...
	public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getColumns(catalog, schemaPattern,
	...
	public ResultSet getColumnPrivileges(String catalog, String schema, String table,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getColumnPrivileges(catalog, schema, table,
			columnNamePattern));
	}
	...
	public ResultSet getTablePrivileges(String catalog, String schemaPattern,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getTablePrivileges(catalog, schemaPattern,
			tableNamePattern));
	}
	...
	public ResultSet getBestRowIdentifier(String catalog, String schema, String table, int scope,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getBestRowIdentifier(catalog, schema,
	...
	public ResultSet getCrossReference(String parentCatalog, String parentSchema,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getCrossReference(parentCatalog,
	...
	public ResultSet getIndexInfo(String catalog, String schema, String table, boolean unique,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getIndexInfo(catalog, schema, table,
			unique, approximate));
	}
	...
	public ResultSet getUDTs(String catalog, String schemaPattern, String typeNamePattern,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getUDTs(catalog, schemaPattern,
	...
	public ResultSet getSuperTypes(String catalog, String schemaPattern, String typeNamePattern)
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getSuperTypes(catalog, schemaPattern,
			typeNamePattern));
	}
	...
	public ResultSet getSuperTables(String catalog, String schemaPattern, String tableNamePattern)
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getSuperTables(catalog, schemaPattern,
			tableNamePattern));
	}
	...
	public ResultSet getAttributes(String catalog, String schemaPattern, String typeNamePattern,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getAttributes(catalog, schemaPattern,
	...
	public ResultSet getFunctions(String catalog, String schemaPattern, String functionNamePattern)
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getFunctions(catalog, schemaPattern,
			functionNamePattern));
	}
	...
	public ResultSet getFunctionColumns(String catalog, String schemaPattern,
		...
		throws SQLException
	{
		return new HaResultSet(haConnection, null, base.getFunctionColumns(catalog, schemaPattern,
